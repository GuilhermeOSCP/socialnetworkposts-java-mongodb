...
import com.guilhermeoscp.socialnetworkposts.dto.AuthorDTO;
import com.guilhermeoscp.socialnetworkposts.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Bom divertimento!", sdf.parse("22/03/2021"), new AuthorDTO(bob));
